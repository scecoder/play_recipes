...
if 'recipes' not in st.session_state:
    initial_entrees = [
        ...
        #SIDES
        {"name": "Bacon Maple Sprouts", "type": "Sides", "method": "Oven", "ingredients": "Brussels Sprouts, Bacon, Breadcrumbs, Maple Syrup", "instructions": "Roast 400°F for 20 mins until crispy."},
        {"name": "AF Garlic Parm Broccoli", "type": "Sides", "method": "Air Fryer", "ingredients": "Broccoli, Pine Nuts, Crouton Crumbs, Parmesan", "instructions": "Air fry 375°F for 8 mins."},
        {"name": "Sweet Potato Chorizo Hash", "type": "Sides", "method": "Stovetop", "ingredients": "Sweet Potato, Chorizo, Onions, Corn", "instructions": "Sauté in skillet until potato is tender."},
        {"name": "Zucchini Almond Gratin", "type": "Sides", "method": "Oven", "ingredients": "Zucchini, Sliced Almonds, Panko, Garlic", "instructions": "Bake 375°F for 15 mins until golden."},
        {"name": "Loaded Cauliflower Bites", "type": "Sides", "method": "Air Fryer", "ingredients": "Cauliflower, Bacon Bits, Potato Cubes, Chives", "instructions": "Air fry 400°F for 15 mins."},
        {"name": "Pecan Green Beans", "type": "Sides", "method": "Stovetop", "ingredients": "Green Beans, Pecans, Dried Cranberries, Butter", "instructions": "Sauté beans 10 mins; toss with nuts/berries."},
        {"name": "Asparagus Prosciutto Toss", "type": "Sides", "method": "Oven", "ingredients": "Asparagus, Prosciutto, Quinoa (cooked), Lemon", "instructions": "Roast 400°F for 12 mins."},
        {"name": "Honey Walnut Carrots", "type": "Sides", "method": "Stovetop", "ingredients": "Carrots, Walnuts, Brown Rice, Honey", "instructions": "Simmer carrots; toss with rice and nuts."},
        {"name": "AF Sesame Bok Choy", "type": "Sides", "method": "Air Fryer", "ingredients": "Bok Choy, Cashews, Ramen Noodles (dry), Soy", "instructions": "Air fry 350°F for 5 mins until charred."},
        {"name": "Cheesy Corn & Peppers", "type": "Sides", "method": "Stovetop", "ingredients": "Bell Peppers, Corn, Pepperoni, Cheddar", "instructions": "Sauté peppers and corn; melt cheese/pepperoni on top."},
        {"name": "Roasted Kale & Chickpeas", "type": "Sides", "method": "Oven", "ingredients": "Kale, Chickpeas, Croutons, Olive Oil", "instructions": "Roast at 375°F until kale is crisp (8 mins)."},
        {"name": "Maple Squash & Pepitas", "type": "Sides", "method": "Oven", "ingredients": "Butternut Squash, Pumpkin Seeds, Farro, Maple", "instructions": "Roast 400°F for 25 mins."},
        {"name": "AF Sausage Pepponata", "type": "Sides", "method": "Air Fryer", "ingredients": "Peppers, Onions, Italian Sausage, Potato", "instructions": "Air fry 380°F for 15 mins."},
        {"name": "Peanut Cabbage Stir-fry", "type": "Sides", "method": "Stovetop", "ingredients": "Cabbage, Peanuts, Rice Vermicelli, Ginger", "instructions": "Stir-fry cabbage/noodles 8 mins; garnish with nuts."},
        {"name": "Garlic Shrimp & Zoodles", "type": "Sides", "method": "Stovetop", "ingredients": "Zucchini Noodles, Shrimp, Couscous, Garlic", "instructions": "Sauté shrimp 3 mins; toss with zoodles/couscous."},
        {"name": "Bacon Wrapped Okra", "type": "Sides", "method": "Air Fryer", "ingredients": "Okra, Bacon, Cornmeal Dust, Salt", "instructions": "Wrap okra in bacon; air fry 400°F for 12 mins."},
        {"name": "Sun-Dried Tomato Spinach", "type": "Sides", "method": "Stovetop", "ingredients": "Spinach, Pine Nuts, Orzo, Sun-dried Tomato", "instructions": "Wilts spinach into cooked orzo/nuts."},
        {"name": "Creamy Peas & Ham", "type": "Sides", "method": "Stovetop", "ingredients": "Peas, Diced Ham, Pearl Barley, Cream", "instructions": "Simmer barley/peas; stir in ham and cream."},
        {"name": "AF Balsamic Radishes", "type": "Sides", "method": "Air Fryer", "ingredients": "Radishes, Walnuts, Pretzel Crumbs, Balsamic", "instructions": "Air fry 375°F for 12 mins."},
        {"name": "Tahini Cauliflower", "type": "Sides", "method": "Oven", "ingredients": "Cauliflower, Pistachios, Chickpea Flour, Tahini", "instructions": "Dust with flour; roast 400°F for 20 mins."},
        {"name": "Mediterranean Eggplant", "type": "Sides", "method": "Oven", "ingredients": "Eggplant, Sliced Almonds, Bulgur, Feta", "instructions": "Roast eggplant cubes; toss with nuts/grain."},
        {"name": "Bacon Cabbage Wedges", "type": "Sides", "method": "Oven", "ingredients": "Cabbage, Bacon, Breadcrumbs, Mustard", "instructions": "Roast wedges 400°F for 25 mins."},
        {"name": "AF Lemon Tahini Broccoli", "type": "Sides", "method": "Air Fryer", "ingredients": "Broccoli, Chickpeas, Quinoa, Tahini", "instructions": "Air fry 375°F for 10 mins."},
        {"name": "Sesame Green Bean Sauté", "type": "Sides", "method": "Stovetop", "ingredients": "Green Beans, Salami Strips, Toasted Sesame, Rice", "instructions": "Sauté beans/salami; serve over rice."},
        {"name": "Chili Lime Corn", "type": "Sides", "method": "Stovetop", "ingredients": "Corn, Pumpkin Seeds, Tortilla Strips, Lime", "instructions": "Char corn in skillet; toss with seeds/strips."},
        {"name": "Parmesan Celery Gratin", "type": "Sides", "method": "Oven", "ingredients": "Celery, Pine Nuts, Breadcrumbs, Parmesan", "instructions": "Bake at 350°F until celery softens (30 mins)."},
        {"name": "AF Buffalo Cauliflower", "type": "Sides", "method": "Air Fryer", "ingredients": "Cauliflower, Blue Cheese, Crackers, Hot Sauce", "instructions": "Air fry 400°F for 15 mins."},
        {"name": "Ginger Carrot Medley", "type": "Sides", "method": "Stovetop", "ingredients": "Carrots, Cashews, Rice, Ginger", "instructions": "Steam carrots in pan; toss with rice/nuts."},
        {"name": "Butternut & Bacon Mash", "type": "Sides", "method": "Stovetop", "ingredients": "Butternut Squash, Bacon, Potato, Chives", "instructions": "Boil squash/potato; mash and top with bacon."},
        {"name": "Crispy Mushroom & Leek", "type": "Sides", "method": "Oven", "ingredients": "Mushrooms, Leeks, Walnuts, Polenta Cubes", "instructions": "Roast 400°F for 20 mins."},
        {"name": "AF Spiced Chickpeas & Kale", "type": "Sides", "method": "Air Fryer", "ingredients": "Kale, Chickpeas, Pita Chips, Cumin", "instructions": "Air fry 350°F for 7 mins."},
        {"name": "Maple Pecan Sweet Potato", "type": "Sides", "method": "Oven", "ingredients": "Sweet Potato, Pecans, Oats, Maple Syrup", "instructions": "Roast potato chunks with oat crumble."},
        {"name": "Sausage & Apple Sprouts", "type": "Sides", "method": "Stovetop", "ingredients": "Brussels Sprouts, Apple, Sausage, Cinnamon", "instructions": "Sauté sprouts and sausage until browned."},
        {"name": "Almond Green Bean Casserole", "type": "Sides", "method": "Oven", "ingredients": "Green Beans, Almonds, Fried Onions, Cream", "instructions": "Bake 350°F for 20 mins."},
        {"name": "AF Zucchini Fries", "type": "Sides", "method": "Air Fryer", "ingredients": "Zucchini, Parmesan, Panko, Garlic Powder", "instructions": "Air fry 400°F for 10 mins."},
        {"name": "Cherry Tomato & Pine Nut", "type": "Sides", "method": "Stovetop", "ingredients": "Tomatoes, Pine Nuts, Couscous, Basil", "instructions": "Blister tomatoes; stir in couscous and nuts."},
        {"name": "Curried Cauliflower", "type": "Sides", "method": "Oven", "ingredients": "Cauliflower, Cashews, Peas, Curry Powder", "instructions": "Roast 400°F for 20 mins."},
        {"name": "AF Sweet Chili Beans", "type": "Sides", "method": "Air Fryer", "ingredients": "Green Beans, Peanuts, Fried Noodles, Chili Sauce", "instructions": "Air fry 375°F for 8 mins."},
        {"name": "Beets & Goat Cheese", "type": "Sides", "method": "Oven", "ingredients": "Beets, Walnuts, Quinoa, Goat Cheese", "instructions": "Roast beets; toss with quinoa and nuts."},
        {"name": "Cheesy Broccoli & Ham", "type": "Sides", "method": "Oven", "ingredients": "Broccoli, Ham, Rice, Cheddar", "instructions": "Bake 375°F for 15 mins."},
        {"name": "AF Teriyaki Peppers", "type": "Sides", "method": "Air Fryer", "ingredients": "Bell Peppers, Sesame Seeds, Rice, Teriyaki Sauce", "instructions": "Air fry 380°F for 10 mins."},
        {"name": "Spinach & Bacon Orzo", "type": "Sides", "method": "Stovetop", "ingredients": "Spinach, Bacon, Orzo, Garlic", "instructions": "Sauté bacon/spinach; stir into hot orzo."},
        {"name": "Roasted Garlic Carrots", "type": "Sides", "method": "Oven", "ingredients": "Carrots, Pistachios, Farro, Garlic", "instructions": "Roast 400°F for 25 mins."},
        {"name": "AF Crispy Artichokes", "type": "Sides", "method": "Air Fryer", "ingredients": "Artichoke Hearts, Parmesan, Panko, Lemon", "instructions": "Air fry 400°F for 12 mins."},
        {"name": "Mushroom & Barley Sauté", "type": "Sides", "method": "Stovetop", "ingredients": "Mushrooms, Barley, Almonds, Thyme", "instructions": "Sauté mushrooms/nuts; mix with cooked barley."},
        {"name": "Cabbage & Corn Hash", "type": "Sides", "method": "Stovetop", "ingredients": "Cabbage, Corn, Bacon, Onions", "instructions": "Fry bacon; sauté veg in rendered fat."},
        {"name": "AF Loaded Radishes", "type": "Sides", "method": "Air Fryer", "ingredients": "Radishes, Bacon, Cheese, Potato Cubes", "instructions": "Air fry 400°F for 15 mins."},
        {"name": "Summer Squash & Feta", "type": "Sides", "method": "Stovetop", "ingredients": "Yellow Squash, Pine Nuts, Couscous, Feta", "instructions": "Sauté squash/nuts; toss with couscous."},
        {"name": "Honey Glazed Parsnips", "type": "Sides", "method": "Oven", "ingredients": "Parsnips, Walnuts, Rice, Honey", "instructions": "Roast 400°F for 20 mins."},
        {"name": "AF Green Bean Fries", "type": "Sides", "method": "Air Fryer", "ingredients": "Green Beans, Egg Wash, Panko, Pecorino", "instructions": "Coat beans; air fry 390°F for 8 mins."},
